...
public class ConfirmationMessage implements HtmlMessage{
	private String html = "\r\n" + "\r\n" + "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\">\r\n"
			...
			+ "								width=\"1\"><img src=\"file:///C:/Users/pc/Documents/git/AgenceVoyage/Spring/src/main/resources/static/images/10274.jpg\"><br>\r\n"
			+ "							<br></td>\r\n" + "						</tr>\r\n"
			+ "					</tbody>\r\n" + "				</table>\r\n" + "			</td>\r\n"
	...
	public ConfirmationMessage(String to, String message,String topic,String name, String link) {
		super();
		this.to=to;
		this.topic =topic;
		this.name=name;
		this.message = message;
		this.link = EmailService.SERVERLINK+link;
	}
	...
	public String generateMessage() {
		html= this.html.replace("{{titre}}", topic);
		html=this.html.replace("{{nom}}", name);
		html = this.html.replace("{{paragraphe}}", this.message);
		html =this.html.replace("{{link}}", this.link);
		return html;
	}
