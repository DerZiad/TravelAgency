				...
				<div class="single-special-offer">
					<div class="single-special-offer-txt">
						...
						<div class="packages-para special-offer-para">
							<p>
								<span> <i class="fa fa-angle-right"></i> 5 daays 6 nights
							...
							<p>
								...
								</span> <span> <i class="fa fa-angle-right"></i> food facilities
								</span>
							</p>
							<p class="offer-para">${voyageReduction.description}</p>
						</div>
						<!--/.packages-para-->
						<div class="offer-btn-group">
							...
							<div class="about-btn">
								<button class="about-view packages-btn"
									onclick="addToChart(${voyageReduction.id})">book now</button>
							</div>
							<!--/.about-btn-->
						</div>
			...
			<div class="col-sm-4">
				<div class="single-special-offer">
					...
					<div class="single-special-shape-txt">
						...
						<p>
							<span>€${voyageReduction.prix}</span><br>reduction
							€${voyageReduction.reductionPrix}
						</p>
					</div>
